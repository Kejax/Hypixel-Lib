...
I'm working on a big update to offer more functions regarding information from the API, such as leaderboards, guilds, friends and else. Also I'm working on the _`documentation <https://hypixel-lib.readthedocs.io>`_ to offer a documentation to explain most of the library.
